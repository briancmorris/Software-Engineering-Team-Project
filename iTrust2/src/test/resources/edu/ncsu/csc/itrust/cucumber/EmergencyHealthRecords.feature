...
Scenario Outline: Search Patient Emergency Health Records By Name
	Given user Shelly with MID: svang is registered as a patient within the iTrust2 system
...
Scenario Outline: Search Patient Emergency Health Records By MID
	...
	Then I am greeted with a printable page present with all relevant info related to emergency records for user "svang"
