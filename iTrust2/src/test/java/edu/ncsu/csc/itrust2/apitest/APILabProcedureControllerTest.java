...
public class APILabProcedureControllerTest {
    ...
    public void testLTFuctions () throws Exception {
         ...
         * MediaType.APPLICATION_JSON ) .content( TestUtils.asJsonString( visit
    ...
    public void testzHCPfunctions () throws Exception {

        mvc.perform( formLogin( "/login" ).user( "hcp" ).password( "pass" ) );

        final OfficeVisitForm visit = new OfficeVisitForm();
        visit.setDate( "4/22/2048" );
        visit.setTime( "8:50 AM" );
        visit.setHcp( "hcp" );
        visit.setPatient( "patient" );
        visit.setNotes( "Test office visit" );
        visit.setType( AppointmentType.GENERAL_CHECKUP.toString() );
        ...
        // Add a new lab procedure to officeVisit created before
        ...
        mvc.perform( put( "api/v1/labProcedures/" + ofv.getId() ).contentType( MediaType.APPLICATION_JSON )
                .content( TestUtils.asJsonString( labForm ) ) ).andExpect( status().isOk() );

        mvc.perform( delete( "api/v1/labProcedures/" + ofv.getId() ).contentType( MediaType.APPLICATION_JSON )
                .content( TestUtils.asJsonString( labID ) ) ).andExpect( status().isOk() );
