...
public class APILabProcedureControllerTest {
    ...
    public void testLTFuctions () throws Exception {
        ...
        labForm.setPriorityLevel( "1" );
        final List<LabProcedureForm> labprocedures = new ArrayList<LabProcedureForm>();
        labprocedures.add( labForm );

        // mvc.perform( delete( "/api/v1/officevisits" ) );
        final OfficeVisitForm visit = new OfficeVisitForm();
        visit.setDate( "5/22/2048" );
        ...
        ofv.save();
        final Long LabProcedureCode = ofv.getLabProcedures().get( 0 ).getId();
        // for future use
         ...
         * labForm.setOfficeVisitId( ofv.getId() ); final LabProcedure lab = new
         * LabProcedure( labForm ); lab.save(); labForm.setID( LabProcedureCode
         * );
         */
        ...
        mvc.perform( get( "/api/v1/labProcedure/" + LabProcedureCode ) ).andExpect( status().isOk() )
